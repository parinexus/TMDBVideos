...
class TopRatedMoviesPagingMediator(
    ...
    override suspend fun load(
        ...
        return try {
            val response = moviesApi.getMoviesList(category = TOP_RATED, page = page)
            ...
            movieDatabase.withTransaction {
                ...
                val movieEntities = response.results.map { it.toDbEntity(TOP_RATED) }
