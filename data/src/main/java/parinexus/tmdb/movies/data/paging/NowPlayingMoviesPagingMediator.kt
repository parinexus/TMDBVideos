...
class NowPlayingMoviesPagingMediator(
    ...
    override suspend fun load(
        ...
        return try {
            val response = moviesApi.getMoviesList(category = NOW_PLAYING, page = page)
            ...
            movieDatabase.withTransaction {
                ...
                val movieEntities = response.results.map { it.toDbEntity(NOW_PLAYING) }
            ...
            Log.e("NowPlayingMoviesMediator", "IO Error: ${e.localizedMessage}")
            MediatorResult.Error(e)
        } catch (e: HttpException) {
            Log.e("NowPlayingMoviesMediator", "HTTP Error: ${e.localizedMessage}")
            MediatorResult.Error(e)
        } catch (e: Exception) {
            Log.e("NowPlayingMoviesMediator", "Unknown Error: ${e.localizedMessage}")
            MediatorResult.Error(e)
        }
    }
}
