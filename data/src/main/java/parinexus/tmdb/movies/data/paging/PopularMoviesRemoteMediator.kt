...
class PopularMoviesPagingMediator(
    ...
    override suspend fun load(
        ...
        return try {
            val response = moviesApi.getMoviesList(category = POPULAR, page = page)
            ...
            movieDatabase.withTransaction {
                ...
                val movieEntities = response.results.map { it.toDbEntity(POPULAR) }
            ...
            Log.e("PopularMoviesMediator", "IO error: ${e.localizedMessage}")
            MediatorResult.Error(e)
        } catch (e: HttpException) {
            Log.e("PopularMoviesMediator", "HTTP error: ${e.localizedMessage}")
            MediatorResult.Error(e)
        } catch (e: Exception) {
            Log.e("PopularMoviesMediator", "Unexpected error: ${e.localizedMessage}")
            MediatorResult.Error(e)
        }
    }
}